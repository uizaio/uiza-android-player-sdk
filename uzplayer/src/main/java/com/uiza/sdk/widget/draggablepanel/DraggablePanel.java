 ...
 */
package com.uiza.sdk.widget.draggablepanel;
...
public class DraggablePanel extends FrameLayout {
    ...
    public void initializeView() {
        ...
        draggableView.setScreenSize(UZViewUtils.getScreenWidth(), UZViewUtils.getScreenHeight());
        draggableView.setTopViewHeight(topFragmentHeight);
    ...
    public void setBottomUZTimebar(final int bottomUZTimebar) {
        if (draggableView != null) {
                ...
                public void onPartOfView(boolean isViewInTopPart) {
                    ...
                    if (isViewInTopPart) {
                        ...
                        if (currentHeight >= screenH) {
                            ...
                            draggableView.getLayoutParams().height = UZViewUtils.getScreenHeight();
            ...
            draggableView.getLayoutParams().height = UZViewUtils.getScreenHeight() + bottomUZTimebar;
            draggableView.setTopViewMarginBottom(bottomUZTimebar * 3);
            draggableView.requestLayout();
        }
    }
